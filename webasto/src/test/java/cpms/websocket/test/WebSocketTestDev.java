...
public class WebSocketTestDev 
{	
	@Test
	public void chargePointConnect1() throws Exception
	{
		SampleWebSocketTestDev swt=new SampleWebSocketTestDev();
        swt.chargePointConnect1("Bajaj","baj_evn_1308","v0.0.1",18587,"Bajaj001","Bajaj001",1);
	}
	@Test
	public void chargePointConnect2() throws Exception
	{
		SampleWebSocketTestDev swt=new SampleWebSocketTestDev();
        swt.chargePointConnect1("Bajaj","baj_evn_1308","v0.0.1",18588,"Bajaj002","Bajaj002",1);
	}
