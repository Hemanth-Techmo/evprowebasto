...
public class TestBase {
	...
	{
		 prop = new Properties();
			FileInputStream fis = new FileInputStream("F:\\CPMS_Webasto_Web\\webasto\\src\\main\\java\\cpms\\webasto\\properties\\properties");
			prop.load(fis);
	}
	...
	public static void initializeDriver() {	
		...
		if (browserName.equals("chrome")) {
			System.setProperty("webdriver.chrome.driver",
					"C:\\Users\\Hemanth\\Downloads\\chromedriver_win32_new\\chromedriver.exe");
	...
	public void initializeWebSocketDriver() throws Exception {
		...
		options.addExtensions(new File("C:\\Users\\Hemanth\\Downloads\\Browser WebSocket Client.crx"));
